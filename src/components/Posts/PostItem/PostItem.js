    ...
    return ( 
        <div className= { classes.PostItem } >
            <div className= { classes.PostItemInfo }>
                ...
                <div style = {{ fontSize: '14px', fontWeight: '600', marginLeft: '8px' }}> name </div>
            </div>
            <div className= { classes.PostItemMedia } ref = { ref } style = {{ height, backgroundColor: 'grey' }}> </div>
            <div className= { classes.PostItemOptions }>
                <div style = {{ marginBottom: '6px' }}>
                    <img src = { HeartIcon } alt = 'like button' style = {{ marginRight: '20px' }} />
